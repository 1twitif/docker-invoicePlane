...
RUN wget http://translations.invoiceplane.com/download/project/fusioninvoice.zip
RUN unzip fusioninvoice.zip -d tmp-lang/ && mv tmp-lang/*/* application/language/ && rm -rf tmp-lang
